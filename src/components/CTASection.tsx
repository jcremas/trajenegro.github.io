  ...
  return (
    <section className="snap-section relative h-[100dvh] flex items-center justify-center bg-background overflow-hidden">
      ...
      >
        ...
        <motion.p
          className="font-serif-display text-[23px] md:text-3xl text-ivory font-light italic mb-3"
          initial={{ opacity: 0 }}
        ...
        <motion.p
          className="font-serif-display text-[23px] md:text-3xl text-ivory font-light italic mb-14"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 0.85 }}
          viewport={{ once: false, amount: 0.3 }}
